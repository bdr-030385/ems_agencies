...
class VendorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contact_number' => ['type' => 'string', 'length' => 80, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-09-23 05:04:54',
            'modified' => '2016-09-23 05:04:54'
        ],
    ];
}
