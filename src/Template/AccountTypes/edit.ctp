...
<ul class="cd-tabs-content" style="width: 100%;float: left;">
  ...
  <div class="page-title" align="center">
    <h1 style="font-size: 30px; color: #000"> Edit Account Type </h1>
  ...
  <div class="portlet light " style="width:100%; float:left;">
    <div class="portlet-title">
      <div class="portlet-body form">
        <!-- BEGIN FORM-->
        <?= $this->Form->create($accountType,['id' => 'frm-default-add', 'data-toggle' => 'validator', 'role' => 'form','class' => 'form-horizontal']) ?>
                    <fieldset>        
                        <?php
                                                            echo "
