                    ...
                    <fieldset>        
                        <?php
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                         echo $this->Form->input('vendor_name', ['value' => $vendorItem->vendor->vendor_name, 'class' => 'form-control', 'id' => 'vendor_id', 'label' => false, 'readonly' => 'readonly', 'disabled' => 'disabled']);                 
                                    echo " </div></div>";    
                                                            echo "
                                    <div class='form-group'>
                    ...
                    <div class="form-group" style="margin-top: 80px;">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="action-fixed-bottom">
                                ...
                                <?= $this->Html->link('<i class="fa fa-angle-left"> </i> ' . __('Back To list'), ['action' => 'vendor', $vendorItem->vendor_id],['class' => 'btn btn-warning', 'escape' => false]) ?>
                            </div>
                        </div>
                    </div>
                    <?= $this->Form->end() ?>
