...
<section class="content-header">
    <h1><?= $vendor->vendor_name . " : " . __('Vendor Items') ?></h1>
    <ol class="breadcrumb">
        ...
        <section class="col-lg-12 ">
            <div class="box " >
                <div class="box-header">
                    <?= $this->Html->link(__('Add New Vendor Item'), ['action' => 'vendor_add', $vendor->id], ['class' => 'btn btn-primary btn-sm', 'escape' => false]) ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['action' => 'vendor_edit', $vendorItem->id],['class' => 'btn btn-success', 'escape' => false]) ?>
                                        ...
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <?= $this->Form->postLink(
                                                        'Yes',
                                                        ['action' => 'vendor_delete', $vendorItem->id],
