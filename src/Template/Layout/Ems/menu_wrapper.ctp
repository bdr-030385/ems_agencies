<div class="page-header">
  ...
  <div class="page-header-top">
    <div class="container">
      <!-- BEGIN LOGO -->
      <div class="page-logo"> <a href="index.html"> <img src="../assets/logoo.png" alt="logo" class="logo-default"> </a> </div>
      <!-- END LOGO -->
        ...
        <div class="container">
          <div class="hor-menu" style="width:100%;">
            <ul class="nav navbar-nav">
              <li class="menu-dropdown classic-menu-dropdown active"> <a href="javascript:;"> Home <span class="arrow"></span> </a> </li>
              ...
              <li class="menu-dropdown mega-menu-dropdown  mega-menu-full"> <a href="javascript:;"> Equipment <span class="arrow"></span> </a> </li>
              ...
              <li class="menu-dropdown mega-menu-dropdown  mega-menu-full"> <a href="javascript:;"> Vehicle Maintenance <span class="arrow"></span> </a> </li>
